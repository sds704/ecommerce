        ...
        <div className="">
            ...
            <div className="input flex justify-center">
                <input
                    ...
                    className=' bg-gray-200 placeholder-gray-400 rounded-lg px-2 py-2 w-60 lg:w-96 md:w-96 outline-none text-black'
                />
            </div>

            {/* search drop-down  */}
            <div className=" flex justify-center">
                {search && <div className="block absolute bg-gray-200 w-60 md:w-96 lg:w-96 z-50 my-1 rounded-lg px-2 py-2">
