  ...
  return (
    <Sidebar>
      <div className="category w-full min-h-screen p-4 overflow-y-auto bg-dry ">
        <h2 className="text-xl font-bold text-white"> All Category</h2>
              ...
              <tbody>
                {allCategories.map((category, index) => (
                  <tr key={category._id} className="hover:bg-dry border border-border">
                    <td className="px-2 py-2 lg:px-6 text-text border border-border">{index+1}</td>
                    <td className="px-2 py-2 lg:px-6 text-text border border-border">{category.type}</td>
