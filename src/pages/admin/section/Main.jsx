...
// import profileimg from '../../../assets/office-man.png'
...
function Main() {
  ...
  const { loading, setLoading, getAllProduct,getAllUser, getAllOrder, getTotalSales } = context;
  ...
  return (
    <div className='w-4/5 bg-white overflow-y-auto flex grow flex-col justify-start items-center gap-2 p-4 h-screen'>
      ...
      <div className="main-section grid grid-cols-1 lg:grid-cols-3 w-full h-scren mt-1 ">
        ...
        {/* left section */}
        <div className="left-section col-span-2  ">
          <div className="w-full md:w-full grid-rows-2 lg:ml-10 ">
            {/* item1 */}
            ...
            {/* item2 */}
            <div className="item1 bg-red-200 hover:bg-red-300 border-1 flex flex-col items-center justify-center gap-4 rounded-xl p-5 m-2 transition-transform transform hover:rotate-[-5deg] hover:scale-105 cursor-pointer w-full lg:w-96">
              <svg
